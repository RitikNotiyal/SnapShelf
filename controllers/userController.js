const authSchema = require('../utils/validation_schema').authSchema;
...
const registerController = async (req, res) => {
    try {
        let { email, fullname, password } = await authSchema.validateAsync(req.body);
        ...
        return res.status(201, "user registered successfully")
    }
    catch (error) {
